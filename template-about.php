    ...
    <main>
        ...
        <div class="card-profile">
                ...
                <div class="card-profile--rosa">
                    ...
                    <div class="card-profile-info">
                        <img class="profile__icon"  src="<?php bloginfo ( 'template_url' ); ?>/images/iconos/about iconos/software-development-icon.svg" alt="Icono de un cerebro">
                        <h3>Web Developer</h3>
        ...
        <div class="card-profile">
                ...
                <div class="card-profile--daniel">
                    ...
                    <div class="card-profile-info">
                        <img class="profile__icon"  src="<?php bloginfo ( 'template_url' ); ?>/images/iconos/about iconos/mobile-app-dev-icon.svg" alt="Icono de un cerebro">
                        <h3>Web Developer</h3>
