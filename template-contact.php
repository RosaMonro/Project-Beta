        ...
        <div class="contact">
            ...
            <form class="h5 label-color" action="" method="post">
                ...
                <label for="nombre">Cómo te llamas</label>
                    <input class="p" type="text" name="name" id="nombre" required aria-label="Escribe tu nombre">

                <label for="email">Correo electrónico</label>
                    <input class="p" type="email" name="email" id="email" required aria-label="Escribe tu correo electrónico">

                <label for="asunto">De qué se trata</label>
                    <input class="p" type="text" name="text" id="asunto" required aria-label="Escribe el asunto">

                <label for="msg">Deja tu comentario</label>
                    <textarea class="p" rows="4"  name="mensaje" id="msg" required aria-label="Escribe tu comentario"></textarea>
